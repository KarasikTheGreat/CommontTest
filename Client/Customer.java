...
public class Customer {
    ...
    private Iterable<Goods> goodsList;

    public Customer(int customersBalance, int customerID,  int maxCountOfDeclines, Iterable<Goods> goodsList) {
        ...
        if (((Collection<?>) goodsList).size() == 0) {
            stillAlive = false;
        }
    }
    ...
    public Order createOrder() {
        ...
        int numberOfProduct = rnd.nextInt(((Collection<?>) goodsList).size());
        int i = 0;
        ...
        return new Order(customerID, goods, rnd.nextInt(10) + 1);
    }
    ...
    public int getCustomersBalance() {
